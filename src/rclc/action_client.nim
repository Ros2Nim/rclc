...
import
  rcl_action/rcl_action, rcl_action/rcl_action, rcl_action/action_client,
  rcl_action/action_client, rcl_action/types, rcl_action/types,
  rcl_action/visibility_control, rcl_action/visibility_control, rcl_action/types,
  rcl_action/types, action_msgs/msg/goal_info, action_msgs/msg/goal_info,
  ...
  rcl_action/types, rcl_action/types, rcl/allocator, rcl/allocator,
  rcutils/allocator, rcl/allocator, rcl_action/types, rcl_action/types, rcl/macros,
  rcl/macros, rcutils/macros, rcl/macros, rcl_action/types, rcl_action/types,
  rcl/types, rcl/types, rmw/types, rmw/types, rmw/types, rmw/types, rmw/types,
  ...
  rmw/types, rcl/types, rcl_action/types, rcl_action/types,
  ...
  rcl_action/action_client, rcl/event_callback, rcl/event_callback,
  rmw/event_callback_type, rmw/event_callback_type, rmw/event_callback_type,
  rmw/event_callback_type, rcl/event_callback, rcl_action/action_client,
  rcl_action/action_client, rcl/macros, rcl_action/action_client,
  rcl_action/action_client, rcl/node, rcl/node, rcl/allocator, rcl/node, rcl/node,
  rcl/arguments, rcl/arguments, rcl/allocator, rcl/arguments, rcl/arguments,
  rcl/log_level, rcl/log_level, rcl/allocator, rcl/log_level, rcl/log_level,
  rcl/macros, rcl/log_level, rcl/log_level, rcl/types, rcl/log_level, rcl/log_level,
  rcl/visibility_control, rcl/visibility_control, rcl/log_level, rcl/arguments,
  rcl/arguments, rcl/macros, rcl/arguments, rcl/arguments, rcl/types, rcl/arguments,
  rcl/arguments, rcl/visibility_control, rcl/arguments, rcl/arguments,
  ...
  rcl_action/action_client, rcl_action/action_client, rcl_action/rcl_action,
  rcl_action/rcl_action, rcl_action/action_server, rcl_action/action_server,
  rcl_action/goal_handle, rcl_action/goal_handle, rcl_action/goal_state_machine,
  ...
  rcl_action/action_server, rcl_action/action_server, rcl/time, rcl/time,
  ...
  rcl/time, rcl/time, rcl/time, rcl_action/action_server, rcl_action/action_server,
  ...
  rcl/graph, rcl/graph, rcl/client, rcl/client,
  ...
  rcl/publisher, rosidl_runtime_c/message_type_support_struct, rcl/publisher,
  rcl/publisher, rcl/macros, rcl/publisher, rcl/publisher, rcl/node, rcl/publisher,
  rcl/publisher, rcl/visibility_control, rcl/publisher, rcl/publisher, rcl/time,
  rcl/publisher, rcl/publisher, rcl/publisher, rcl/publisher, rcl/publisher,
  rcl/publisher, rcl/publisher, rcl/publisher, rcl/publisher, rcl/client, rcl/client,
  rcl/service_introspection, rcl/client, rcl/client, rcl/time, rcl/client,
  rcl/client, rcl/visibility_control, rcl/client, rcl/client, rmw/types, rcl/client,
  rcl/client, rcl/client, rcl/graph, rcl/graph, rcl/node, rcl/graph, rcl/graph,
  rcl/visibility_control, rcl/graph, rcl/graph, rcl/graph, rcl/graph, rcl/graph,
  rcl/graph, rcl/graph, rcl/graph, rcl/graph, rcl/graph, rcl/graph, rcl/graph,
  rcl/graph, rcl/graph, rcl/graph, rcl/graph, rcl/graph, rcl_action/graph,
  ...
  rcl/subscription, rcl/subscription, rcl/event_callback, rcl/subscription,
  rcl/subscription, rcl/macros, rcl/subscription, rcl/subscription, rcl/node,
  ...
  rcl/subscription, rcl/subscription, rcl/subscription, rcl/subscription,
  rcl/subscription, rcl/wait, rcl/wait, rcl/timer, rcl/timer, rcl/timer, rcl/timer,
  rcl/allocator, rcl/allocator, rcl/timer, rcl/timer, rcl/context, rcl/timer,
  rcl/timer, rcl/event_callback, rcl/timer, rcl/timer, rcl/guard_condition,
  rcl/timer, rcl/timer, rcl/macros, rcl/timer, rcl/timer, rcl/time, rcl/timer,
  rcl/timer, rcl/types, rcl/timer, rcl/timer, rmw/rmw, rmw/rmw, rmw/rmw, rmw/rmw,
  rmw/rmw, rmw/rmw, rcutils/allocator, rcutils/allocator, rmw/rmw, rmw/rmw,
  rcutils/macros, rmw/rmw, rmw/rmw, rcutils/types, rmw/rmw, rmw/rmw,
  ...
  ./types, ./types, rcl/time, ./types, ./types, ./types, ./action_goal_handle,
...
type
  ...
  rclc_action_client_cancel_callback_t* = proc (
      goal_handle: ptr rclc_action_goal_handle_t; cancelled: _Bool; args: pointer)
  rclc_action_client_t* {.importc: "rclc_action_client_t",
    ...
    ros_cancel_response* {.importc: "ros_cancel_response".}: action_msgs__srv__CancelGoal_Response
    ##  Available flags
...
## !!!Ignored construct:  __attribute__ ( ( visibility ( default ) ) ) rcl_ret_t rclc_action_client_init_default ( rclc_action_client_t * action_client , rcl_node_t * node , const rosidl_action_type_support_t * type_support , const char * action_name ) ;
...
## !!!Ignored construct:  __attribute__ ( ( visibility ( default ) ) ) rcl_ret_t rclc_action_send_goal_request ( rclc_action_client_t * action_client , void * ros_request , rclc_action_goal_handle_t * * goal_handle ) ;
## Error: identifier expected, but got: ) (pxParRi)!!!
...
## !!!Ignored construct:  __attribute__ ( ( visibility ( default ) ) ) rcl_ret_t rclc_action_send_cancel_request ( rclc_action_goal_handle_t * goal_handle ) ;
## Error: identifier expected, but got: ) (pxParRi)!!!
...
## !!!Ignored construct:  __attribute__ ( ( visibility ( default ) ) ) rcl_ret_t rclc_action_client_fini ( rclc_action_client_t * action_client , rcl_node_t * node ) ;
## Error: identifier expected, but got: ) (pxParRi)!!!
