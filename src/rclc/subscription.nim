...
import
  ...
  rcutils/macros, rcl/macros, rcl/subscription, rcl/subscription, rcl/node, rcl/node,
  ...
  rcl/subscription, rcl/subscription, rcl/visibility_control, rcl/subscription,
  rcl/subscription, rmw/message_sequence, rmw/message_sequence,
  rmw/message_sequence, rmw/message_sequence, rmw/macros, rmw/macros,
  rmw/message_sequence, rmw/message_sequence, rmw/visibility_control,
  rmw/message_sequence, rmw/message_sequence, rmw/types, rmw/message_sequence,
  rcl/subscription, rcl/subscription, rcl/subscription, rcl/subscription,
  rcl/subscription, rcl/subscription, rcl/subscription, rcl/subscription,
  rcl/subscription, ./types, ./types, rcl/context, ./types, ./types, rcl/allocator,
  ./types, ./types, rcl/time, rcl/time, rcl/allocator, rcl/time, rcl/time, rcl/macros,
  ...
  rcl/time, rcl/time, rcl/time, rcl/time, rcl/time, ./types, ./types, ./types, ./init,
  ./init, rcl/allocator, ./init, ./init, ./types, ./init, ./init, ./visibility_control,
  ./visibility_control, ./init, ./visibility_control, ./visibility_control
...
## !!!Ignored construct:  __attribute__ ( ( visibility ( default ) ) ) rcl_ret_t rclc_subscription_init_default ( rcl_subscription_t * subscription , rcl_node_t * node , const rosidl_message_type_support_t * type_support , const char * topic_name ) ;
...
## !!!Ignored construct:  __attribute__ ( ( visibility ( default ) ) ) rcl_ret_t rclc_subscription_init_best_effort ( rcl_subscription_t * subscription , rcl_node_t * node , const rosidl_message_type_support_t * type_support , const char * topic_name ) ;
## Error: identifier expected, but got: ) (pxParRi)!!!
...
## !!!Ignored construct:  __attribute__ ( ( visibility ( default ) ) ) rcl_ret_t rclc_subscription_init ( rcl_subscription_t * subscription , rcl_node_t * node , const rosidl_message_type_support_t * type_support , const char * topic_name , const rmw_qos_profile_t * qos_profile ) ;
## Error: identifier expected, but got: ) (pxParRi)!!!
