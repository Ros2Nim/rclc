...
import
  rcl/node, rcl/node, rcl/node, rcl/node, rcl/allocator, rcl/allocator, rcl/allocator,
  ...
  rcl/time, rcl/time, rcl/allocator, rcl/time, rcl/time, rcl/macros, rcl/time,
  rcl/time, rcl/types, rcl/time, rcl/time, rcl/visibility_control, rcl/time, rcl/time,
  rcutils/time, rcl/time, rcl/time, rcl/time, rcl/time, rcl/time, rcl/time, rcl/time,
  rcl/time, rcl/time, rcl/time, rcl/time, ./types, ./types, ./types, ./init, ./init,
  rcl/allocator, ./init, ./init, ./types, ./init, ./init, ./visibility_control,
...
## !!!Ignored construct:  __attribute__ ( ( visibility ( default ) ) ) rcl_ret_t rclc_node_init_default ( rcl_node_t * node , const char * name , const char * namespace_ , rclc_support_t * support ) ;
...
## !!!Ignored construct:  __attribute__ ( ( visibility ( default ) ) ) rcl_ret_t rclc_node_init_with_options ( rcl_node_t * node , const char * name , const char * namespace_ , rclc_support_t * support , rcl_node_options_t * node_ops ) ;
## Error: identifier expected, but got: ) (pxParRi)!!!
