...
import
  ...
  rcutils/allocator, rosidl_runtime_c/service_type_support_struct,
  rosidl_runtime_c/service_type_support_struct,
  ...
  rcl/allocator, rcl/allocator, rcutils/allocator, rcl/allocator, rcl/service,
  rcl/service, rcl/event_callback, rcl/event_callback, rmw/event_callback_type,
  rmw/event_callback_type, rmw/event_callback_type, rmw/event_callback_type,
  rcl/event_callback, rcl/service, rcl/service, rcl/macros, rcl/macros,
  rcutils/macros, rcl/macros, rcl/service, rcl/service, rcl/node, rcl/node,
  rcl/allocator, rcl/node, rcl/node, rcl/arguments, rcl/arguments, rcl/allocator,
  rcl/arguments, rcl/arguments, rcl/log_level, rcl/log_level, rcl/allocator,
  rcl/log_level, rcl/log_level, rcl/macros, rcl/log_level, rcl/log_level, rcl/types,
  rcl/types, rmw/types, rmw/types, rmw/types, rmw/types, rmw/types, rmw/types,
  rmw/types, rcutils/logging, rcutils/logging, rcutils/logging, rcutils/logging,
  ...
  rcl/service, rcl/service, rcl/publisher, rcl/publisher,
  ...
  rcl/publisher, rcl/service, rcl/service, rcl/service_introspection, rcl/service,
  rcl/service, rcl/time, rcl/service, rcl/service, rcl/visibility_control,
  rcl/service, rcl/service, rmw/types, rcl/service, rcl/service, rcl/service,
...
## !!!Ignored construct:  __attribute__ ( ( visibility ( default ) ) ) rcl_ret_t rclc_service_init_default ( rcl_service_t * service , const rcl_node_t * node , const rosidl_service_type_support_t * type_support , const char * service_name ) ;
...
## !!!Ignored construct:  __attribute__ ( ( visibility ( default ) ) ) rcl_ret_t rclc_service_init_best_effort ( rcl_service_t * service , const rcl_node_t * node , const rosidl_service_type_support_t * type_support , const char * service_name ) ;
## Error: identifier expected, but got: ) (pxParRi)!!!
...
## !!!Ignored construct:  __attribute__ ( ( visibility ( default ) ) ) rcl_ret_t rclc_service_init ( rcl_service_t * service , const rcl_node_t * node , const rosidl_service_type_support_t * type_support , const char * service_name , const rmw_qos_profile_t * qos_profile ) ;
## Error: identifier expected, but got: ) (pxParRi)!!!
