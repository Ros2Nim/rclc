...
import
  rcl/service, rosidl_runtime_c/service_type_support_struct, rcutils/allocator,
...
proc rclc_service_init_default*(service: ptr rcl_service_t;
                                node: ptr rcl_node_t; type_support: ptr rosidl_service_type_support_t;
                                service_name: cstring): rcl_ret_t {.
    importc: "rclc_service_init_default", header: "rcl/service.h".}
  ##
                              ##
...
proc rclc_service_init_best_effort*(service: ptr rcl_service_t;
                                    node: ptr rcl_node_t; type_support: ptr rosidl_service_type_support_t;
                                    service_name: cstring): rcl_ret_t {.
    importc: "rclc_service_init_best_effort", header: "rcl/service.h".}
  ##
                              ##
...
proc rclc_service_init*(service: ptr rcl_service_t; node: ptr rcl_node_t;
                        type_support: ptr rosidl_service_type_support_t;
                        service_name: cstring;
                        qos_profile: ptr rmw_qos_profile_t): rcl_ret_t {.
    importc: "rclc_service_init", header: "rcl/service.h".}
  ##
                              ##
