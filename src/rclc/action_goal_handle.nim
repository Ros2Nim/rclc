...
type
  ...
  INNER_C_UNION_action_goal_handle.h_10* {.
    ...
    goal_request_sequence_number* {.importc: "goal_request_sequence_number".}: int64_t

  INNER_C_UNION_action_goal_handle.h_12* {.
      importc: "rclc_action_goal_handle_t::no_name",
      header: "rcl/action_goal_handle.h", bycopy, union.} = object
    result_request_header* {.importc: "result_request_header".}: rmw_request_id_t
    result_request_sequence_number* {.importc: "result_request_sequence_number".}: int64_t

  INNER_C_UNION_action_goal_handle.h_14* {.
      importc: "rclc_action_goal_handle_t::no_name",
      header: "rcl/action_goal_handle.h", bycopy, union.} = object
    cancel_request_header* {.importc: "cancel_request_header".}: rmw_request_id_t
    cancel_request_sequence_number* {.importc: "cancel_request_sequence_number".}: int64_t
  ...
  rclc_action_goal_handle_t* {.importc: "rclc_action_goal_handle_t",
    ...
    goal_id* {.importc: "goal_id".}: unique_identifier_msgs__msg__UUID
...
const
  DECLARE_GOAL_HANDLE_POOL* = constructrclc_action_goal_handle_t *
      goal_handles_memory

## ignored statement

var goal_handles_memory_size* {.importc: "goal_handles_memory_size",
                              header: "rcl/action_goal_handle.h".}: csize_t

var free_goal_handles* {.importc: "free_goal_handles",
                       header: "rcl/action_goal_handle.h".}: ptr rclc_action_goal_handle_t

var used_goal_handles* {.importc: "used_goal_handles",
                       header: "rcl/action_goal_handle.h".}: ptr rclc_action_goal_handle_t
