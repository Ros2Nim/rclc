...
import
  ./visibility_control, ./visibility_control, rcl_action/rcl_action,
  rcl_action/rcl_action, rcl_action/action_client, rcl_action/action_client,
  rcl_action/types, rcl_action/types, rcl_action/visibility_control,
  rcl_action/visibility_control, rcl_action/types, rcl_action/types,
  action_msgs/msg/goal_info, action_msgs/msg/goal_info,
...
## !!!Ignored construct:  __attribute__ ( ( visibility ( default ) ) ) rcl_ret_t rclc_action_server_init_default ( rclc_action_server_t * action_server , rcl_node_t * node , rclc_support_t * support , const rosidl_action_type_support_t * type_support , const char * action_name ) ;
...
## !!!Ignored construct:  __attribute__ ( ( visibility ( default ) ) ) rcl_ret_t rclc_action_send_result ( rclc_action_goal_handle_t * goal_handle , rcl_action_goal_state_t status , void * ros_response ) ;
## Error: identifier expected, but got: ) (pxParRi)!!!
...
## !!!Ignored construct:  __attribute__ ( ( visibility ( default ) ) ) rcl_ret_t rclc_action_publish_feedback ( rclc_action_goal_handle_t * goal_handle , void * ros_feedback ) ;
## Error: identifier expected, but got: ) (pxParRi)!!!
...
## !!!Ignored construct:  __attribute__ ( ( visibility ( default ) ) ) rcl_ret_t rclc_action_server_fini ( rclc_action_server_t * action_server , rcl_node_t * node ) ;
## Error: identifier expected, but got: ) (pxParRi)!!!
