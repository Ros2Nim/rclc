...
import
  ...
  rcl/allocator, rcl/allocator, rcutils/allocator, rcl/allocator, rcl/client,
  rcl/client, rcl/event_callback, rcl/event_callback, rmw/event_callback_type,
  rmw/event_callback_type, rmw/event_callback_type, rmw/event_callback_type,
  rcl/event_callback, rcl/client, rcl/client, rcl/macros, rcl/macros, rcutils/macros,
  rcl/macros, rcl/client, rcl/client, rcl/node, rcl/node, rcl/allocator, rcl/node,
  rcl/node, rcl/arguments, rcl/arguments, rcl/allocator, rcl/arguments,
  rcl/arguments, rcl/log_level, rcl/log_level, rcl/allocator, rcl/log_level,
  rcl/log_level, rcl/macros, rcl/log_level, rcl/log_level, rcl/types, rcl/types,
  ...
  rcl/client, rcl/client, rcl/publisher, rcl/publisher,
  ...
  rcl/publisher, rcl/client, rcl/client, rcl/service_introspection, rcl/client,
  rcl/client, rcl/time, rcl/client, rcl/client, rcl/visibility_control, rcl/client,
  rcl/client, rmw/types, rcl/client, rcl/client, rcl/client, rcl/allocator, ./types,
  ./types, rcl/context, ./types, ./types, rcl/allocator, ./types, ./types, rcl/time,
  ./types, ./types, ./types, ./visibility_control, ./visibility_control
...
## !!!Ignored construct:  __attribute__ ( ( visibility ( default ) ) ) rcl_ret_t rclc_client_init_default ( rcl_client_t * client , const rcl_node_t * node , const rosidl_service_type_support_t * type_support , const char * service_name ) ;
...
## !!!Ignored construct:  __attribute__ ( ( visibility ( default ) ) ) rcl_ret_t rclc_client_init_best_effort ( rcl_client_t * client , const rcl_node_t * node , const rosidl_service_type_support_t * type_support , const char * service_name ) ;
## Error: identifier expected, but got: ) (pxParRi)!!!
...
## !!!Ignored construct:  __attribute__ ( ( visibility ( default ) ) ) rcl_ret_t rclc_client_init ( rcl_client_t * client , const rcl_node_t * node , const rosidl_service_type_support_t * type_support , const char * service_name , const rmw_qos_profile_t * qos_profile ) ;
## Error: identifier expected, but got: ) (pxParRi)!!!
